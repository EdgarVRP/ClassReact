...
class AboutUs extends Component {
  renderAboutMe = () => {
    return data.map((item) => <AboutMe key={item.id} {...item} />);
  };
        ...
        <Card id="card">
          ...
          >
            ...
            >
              ...
              <Link
                sx={{ fontSize: "1.2rem" }}
                href="https://pixeljeff1995.artstation.com"
                target={"_blank"}
              >
            ...
            <Grid item xs={12} lg={4} sx={{ marginTop: 2, marginBottom: 1 }}>
              <Link
                href="https://www.instagram.com/pixeljeff_design/"
                target={"_blank"}
                sx={{ display: "flex", justifyContent: "center" }}
              >
                <img
                  src={jeffInstagram}
                  alt={"Jeff Pixel Instagram"}
                />
              </Link>
            </Grid>
            <Grid
            ...
            >
              <Link
                href="https://www.facebook.com/PixelJeff/"
                target={"_blank"}
                sx={{ display: "flex", justifyContent: "center" }}
              >
